...
namespace AdTool.AzSponsoredProducts.BusinessObjects.Keyword.ProductTargets
{
    ...
    public class ProductTargetUpdateResponse
    {
        public TargetingClauses targetingClauses { get; set; }
        public ProductTargetUpdateResponse()
        {
            targetingClauses = new TargetingClauses();
        }
    }
    ...
    {
        public TargetingClause targetingClause { get; set; }
