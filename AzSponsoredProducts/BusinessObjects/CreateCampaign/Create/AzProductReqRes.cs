...
{
    //request
    public class APIProductsRequestRoot
    {
        public List<APIProductsRequest> productAds { get; set; }
        public APIProductsRequestRoot()
        {
            productAds = new List<APIProductsRequest>();
        }
    }

    public class APIProductsRequest
    {
    ...
    //response
    public class AdEligibilityError
    {
    ...
    public class AsinOwnershipError
    {
        public string reason { get; set; }
        public Cause cause { get; set; }
        public string message { get; set; }
    ...
    public class ErrorValue
    {
        ...
        public AsinOwnershipError asinOwnershipError { get; set; }
        ...
        public ProductIdentifierError productIdentifierError { get; set; }
        public AdEligibilityError adEligibilityError { get; set; }
    ...
    {
        public List<SuccessAd> success { get; set; }
        public List<Error> error { get; set; }
    }

    public class ProductIdentifierError
    {
        public string reason { get; set; }
        public string marketplace { get; set; }
        public Cause cause { get; set; }
    ...
    public class ProductAdsResponseRoot
    {
        public ProductAds productAds { get; set; }
    }
    ...
    public class SuccessAd
    {
        public string adId { get; set; }
        public int index { get; set; }
        public ProductAd productAd { get; set; }
    }
