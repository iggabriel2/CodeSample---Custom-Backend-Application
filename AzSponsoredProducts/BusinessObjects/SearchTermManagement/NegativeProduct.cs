...
namespace AdTool.AzSponsoredProducts.BusinessObjects.SearchTermManagement
{
    ...
    public class NegativeTargetingClause
    {
        public List<Expression> expression { get; set; }
        public string campaignId { get; set; }
        public string state { get; set; }
        public string adGroupId { get; set; }
        public NegativeTargetingClause()
        {
    ...
    {
        public List<NegativeTargetingClause> negativeTargetingClauses { get; set; }
        public NegativeProduct()
        {
            negativeTargetingClauses = new List<NegativeTargetingClause>();
        }
    }
    ...
    public class ErrorValue
    {
        ...
        public ExpressionTypeError expressionTypeError { get; set; }
        ...
        public ErrorValue()
        {
            ...
            expressionTypeError = new ExpressionTypeError();
    ...
    public class ExpressionErrorHere
    {
        public string type { get; set; }
        public string value { get; set; }
    }
    ...
    public class NegativeTargetingClauseResponse
    {
        public List<Expression> expression { get; set; }
        ...
        public NegativeTargetingClauseResponse()
        {
            expression = new List<Expression>();
    ...
    public class NegativeTargetingClauses
    {
        public List<Success> success { get; set; }
        public List<Error> error { get; set; }
        public NegativeTargetingClauses()
        {
    ...
    public class NegativeProductResponseRoot
    {
        public NegativeTargetingClauses negativeTargetingClauses { get; set; }
        public NegativeProductResponseRoot()
        {
            negativeTargetingClauses = new NegativeTargetingClauses();
        }
    }
    ...
    public class Success
    {
        public string targetId { get; set; }
        public int index { get; set; }
        public NegativeTargetingClauseResponse negativeTargetingClause { get; set; }
        public Success()
        {
            negativeTargetingClause = new NegativeTargetingClauseResponse();
        }
    }

    public class TargetingClause
    {
        public List<ExpressionErrorHere> expression { get; set; }
        public string targetId { get; set; }
        public List<ResolvedExpression> resolvedExpression { get; set; }
        public string campaignId { get; set; }
        ...
        public string adGroupId { get; set; }
        public ExtendedData extendedData { get; set; }
        public TargetingClause()
        {
            expression = new List<ExpressionErrorHere>();
            resolvedExpression = new List<ResolvedExpression>();
            extendedData = new ExtendedData();
        }
    }
